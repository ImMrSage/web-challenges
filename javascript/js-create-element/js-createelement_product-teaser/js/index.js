...
const angelfishArticle = document.createElement("article");
document.body.append(angelfishArticle);
angelfishArticle.classList.add("product");

angelfishArticle.innerHTML = `    <div class="product__body">
